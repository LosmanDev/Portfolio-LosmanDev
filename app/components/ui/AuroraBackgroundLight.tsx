...
interface AuroraBackgroundLightProps
...
export const AuroraBackgroundLight: React.FC<AuroraBackgroundLightProps> = ({
  className,
  children,
  ...
  return (
    <main>
      <div
        className={cn(
          ' bg-white dark:bg-zinc-50 text-zinc-900 transition-bg',
          className,
        )}
        {...props}
      >
