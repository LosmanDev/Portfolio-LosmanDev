            ...
            <div className="flex flex-col sm:flex-row">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center">
                  <Image
                    className="w-25 h-20 rounded-full transition duration-300 ease-in-out transform hover:scale-[3] active:scale-95"
                    src={liban}
                ...
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <div className="flex flex-row items-center gap-2">
                    <a href="https://www.linkedin.com/in/liban-osman-losmandev/">
                      <svg
                    ...
                    <a href="https://github.com/LosmanDev">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1.5em"
                        height="1.5em"
              ...
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l dark:border-white border-black sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <HoverBorderGradient>
                  <p className="leading-relaxed sm:text-base font-normal text-xs mb-4 p-4 dark:text-white">
                    ...
                    ones. My technical experience gives me the confidence to
                    pick up new information rapidly and tackle difficult
                    problems. I'm driven to learn and progress in this
                    ever-evolving field. Ready to digitalize ideas into user
                    friendly, mobile-responsive, elegant projects and solutions.
                  </p>
                </HoverBorderGradient>
              </div>
            </div>
